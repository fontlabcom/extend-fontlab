...
# Shared theme integration: extend-fontlab

## Extension catalogue

The catalogue was modernized to ProperDocs/MaterialX under `src_docs/md/`. Shared components replace duplicated styling while public paths and downloadable assets are preserved.
...
|---|---|---|
| `src_docs/mkdocs.yml` | active publication configuration | https://extend.fontlab.com/ |

## Build and publish responsibility

Run `./build.sh`; publish generated `docs/` through the existing GitHub Pages route. Keep extension downloads and legacy URLs intact.
